#include "png_util.h"
  ...
  *
  *
  *    DV: Modified version from: https://en.wikibooks.org/wiki/OpenGL_Programming/Intermediate/Textures
  *
  */

 //GLuint loadColourmapTexture(const string filename, int &width, int &height)
